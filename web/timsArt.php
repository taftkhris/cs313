...
//    $product_row = $db->query('SELECT title, description, dimensions, price, image FROM product');
    $stmt = $db->query('SELECT title, description, dimensions, price, image FROM product');
      ...
      <div class="row">
        <div class="col-lg-4 col-sm-6 portfolio-item">
          <div class="card h-100">
            <a href="#"><img class="card-img-top" src="http://placehold.it/700x400"<?php //echo "artWork/" . $imageLocation;?> alt=""></a>
            <div class="card-body"> 
              <h4 class="card-title">
